            ...
            imageSet = [...imageSet , this.state.page[this.state.curPage].map((image) => {
                if(image[2] && this.state.curPage != 0) {
                    ...
                    return(
                        ...
                        <div className="images m-1"> 
                         <img key={image[1]} onClick={(e) => this.imageClick(e, {image})} style={{maxWidth: "100%", maxHeight: "100%"}} src={image[0]}></img>
                         </div> 
                      ); 
                } else if(image[2]) {
                    ...
                    return(
                       ...
                       <div onLoad={(e) => {console.log(e.target.src)}} className="images m-1"> <img key={image[1]} onClick={() => this.props.changeCanvasBackground(image[0])} style={{maxWidth: "100%", maxHeight: "100%"}} src={image[0]}></img>
                        </div>
                      ); 
                }
