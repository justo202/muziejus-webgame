export var images = [
    [
        ["./assets/fonai/fonas_aikštė su fontanu.jpg", 42, true, "./assets/fonai_low/fonas_aikštė su fontanu.jpg"],
        ["./assets/fonai/fonas_kazimiero tapetas raudonas.jpg", 43, true, "./assets/fonai_low/fonas_kazimiero tapetas raudonas.jpg"],
        ["./assets/fonai/fonas_kazimiero tapetas.jpg", 44, true, "./assets/fonai_low/fonas_kazimiero tapetas.jpg"],
        ["./assets/fonai/fonas_kluatras.png", 45, true, "./assets/fonai_low/fonas_kluatras.png"],
        ["./assets/fonai/fonas_medis su namukais.jpg", 46, true, "./assets/fonai_low/fonas_medis su namukais.jpg"],
        ["./assets/fonai/fonas_nusitrynęs.png", 47, true, "./assets/fonai_low/fonas_nusitrynęs.png"],
        ["./assets/fonai/fonas_pagrindinis.jpg", 48, true, "./assets/fonai_low/fonas_pagrindinis.jpg"],
        ["./assets/fonai/fonas_plytelės.jpg", 49, true, "./assets/fonai_low/fonas_plytelės.jpg"],
        ["./assets/fonai/fonas_raudonas smulkus.png", 50, true, "./assets/fonai_low/fonas_raudonas smulkus.png"],
        ["./assets/fonai/fonas_skliautai sulygiuoti.png", 51, true, "./assets/fonai_low/fonas_skliautai sulygiuoti.png"],
        ["./assets/fonai/fonas_skliautai.jpg", 52, true, "./assets/fonai_low/fonas_skliautai.jpg"],
        ["./assets/fonai/fonas_žalias smulkus.png", 53, true, "./assets/fonai_low/fonas_žalias smulkus.png"],
